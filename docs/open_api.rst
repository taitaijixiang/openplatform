...
| 参数      | 必选 | 类型以及范围                                            | 说明             |
+===========+======+=========================================================+==================+
| client_id | 是   | 合作方在平台的唯一标识，并配置密码                      | 客户端id         |
+-----------+------+---------------------------------------------------------+------------------+
| preUrl    | 是   | 参照: :ref:`request_url`                                | 服务器端地址前缀 |
+-----------+------+---------------------------------------------------------+------------------+
| timestamp | 是   | 时间格式：yyyy-MM-dd HH:mm:ss                           | 时间戳           |
+-----------+------+---------------------------------------------------------+------------------+
| version   | 否   | 默认是1.0                                               | 版本号           |
+-----------+------+---------------------------------------------------------+------------------+
| sign      | 是   | 所有请求参数按照字典序排序后再加上客户端密码进行md5加密 | 请求签名         |
+-----------+------+---------------------------------------------------------+------------------+
